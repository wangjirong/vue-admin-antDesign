<template>
    <div class="login cover fixed">
        <video class="video-source cover fixed" width="100vw" height="100vh"
        ...
        <div class="login-area flex-column-center">
            ...
            <a-input ref="userNameInput" v-model="admin.userName" placeholder="用户名" style="margin: 10px 0">
                <a-icon slot="prefix" type="user"/>
            </a-input>
            <a-input-password placeholder="密码" v-model="admin.password">
                <a-icon slot="prefix" type="lock"></a-icon>
            </a-input-password>
            <a-button type="primary" block style="margin: 10px 0" @click.native="login">
                登录
            </a-button>
